...
python main.py --device_num 7 --coco_path ./data/coco/ --output_dir rerun_anchor_VOC_SAM_only_backbone --wandb_run_name rerun_anchor_VOC_SAM_only_backbone --backbone SAM --eval_checkpoint_period 5 --freeze_backbone
